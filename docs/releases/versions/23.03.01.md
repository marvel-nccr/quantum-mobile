...
Get Quantum Mobile running on your computer in three simple steps:
 ...
 1. Download virtual machine image (6.1 GB)
    - URL: <https://object.cscs.ch/v1/AUTH_b1d80408b3d340db9f03d373bbde5c1e/marvel-vms/quantum_mobile_23.03.01.ova>
...
This build upgrades Quantum Mobile to Ubuntu 20.04.4 LTS,
and introduces the [mambaforge](https://github.com/conda-forge/miniforge) package management system.
